...
function GitHub() {
    ...
    const StatBadge = ({ label, value }) => (
        <div
            ...
            "
        >
            <span className="heading-card !text-2xl md:!text-3xl text-blue-700 dark:text-blue-300 tracking-tight">
                {value}
            </span>
            <span className="mt-1 text-meta uppercase tracking-wide">{label}</span>
        </div>
    );
            ...
            >
                <div className="relative z-0 w-full max-w-5xl flex flex-col gap-14">
                    ...
                    >
                        ...
                        <h1 className="heading-section text-center md:text-left drop-shadow">
                            GitHub Presence
                        </h1>
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-10 w-full">
                            <div className="flex flex-col items-center md:items-start gap-5">
                                ...
                                <div className="flex flex-col items-center md:items-start">
                                    <h2 className="heading-card tracking-tight">
                                        {profile?.name || profile?.login}
                                    </h2>
                                    <p className="text-meta">@{profile?.login}</p>
                                </div>
                                {profile?.bio && (
                                    <p className="text-body max-w-xs md:max-w-sm text-center md:text-left">
                                        {profile.bio}
                                    </p>
                                )}
                    ...
                    <section
                        className="
                            ...
                            p-8 md:p-12 rounded-3xl overflow-hidden
                            border border-zinc-200 dark:border-zinc-800
                            bg-gradient-to-br from-zinc-100 via-zinc-50 to-zinc-200
                            dark:from-zinc-900 dark:via-zinc-950 dark:to-zinc-900
                            shadow-xl flex flex-col md:flex-row gap-6
                            items-center justify-between
                        "
                    >
                        <div className="absolute inset-0 pointer-events-none [mask-image:radial-gradient(circle_at_center,black,transparent_80%)]" />
                        <div className="flex-1 relative z-10">
                            <h3 className="heading-card mb-2 tracking-tight text-center md:text-left">
                                Exploring the Code
                            </h3>
                            <div className="text-body max-w-lg text-center md:text-left">
                        ...
                        <a
                            ...
                            rel="noopener noreferrer"
                            className="
                                relative z-10 px-6 py-3 rounded-xl font-semibold text-sm md:text-base
                                bg-zinc-900 dark:bg-zinc-50
                                text-zinc-50 dark:text-zinc-900
                                hover:bg-zinc-800 dark:hover:bg-zinc-200
