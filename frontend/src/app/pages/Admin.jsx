            ...
            case 'Users':
                return (
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col md:flex-row gap-2 mb-2 md:items-center">
                            <input
                                value={userSearch}
                                onChange={(e) => setUserSearch(e.target.value)}
                                placeholder="Search users..."
                                className={inputClasses() + ' w-full md:w-auto'}
                            />
                        ...
                        {createUserOpen && (
                            <form
                                ...
                                className="flex flex-col gap-3 p-4 border rounded-xl bg-zinc-50/80 dark:bg-zinc-800/60 w-full max-w-lg mx-auto"
                            >
